...
class ExcelTable extends React.Component {
  ...
  EventKeyBoardChangeValue = (row, col) => {
    ...
    if (this.props.value[0] != "=") {
      ...
      if (this.props.value.length === 1) {
        ...
        (this.props.value[1] > "a" && this.props.value[1] < "z") ||
        (this.props.value[1] > "A" && this.props.value[1] < "Z")
      ) {
        for (let i = 0; i < this.props.value.length; i++) {
          for (let j = 1; j < this.props.value.length; j++) {
            if (
              (this.props.value[i] > "a" && this.props.value[i] < "z") ||
              (this.props.value[i] > "A" && this.props.value[i] < "Z")
            ) {
        ...
        newValue[row][col] = require("../../../calculator").parse(
  ...
  handleDown = (event) => {
    ...
    let oldCol = this.props.col;
    if (event.key === "Shift") {
      this.props.changeKeyboard(true);
      ...
      this.props.showInput(false);
      this.props.checkPointer(true);
      this.props.changeValueFlag(
        this.props.dataTable[this.props.row][this.props.col]
      );
      ...
      newData[this.props.row][this.props.col] = this.props.dataCopied;
        ...
        <div>
          <div
            style={{
              display: "flex",
              width:
                this.props.width * (this.props.nColumns + 1) +
                this.props.widthRow,
            }}
          >
            <div
              style={{
                width: this.props.widthRow,
                height: this.props.heightCol,
                backgroundColor: "#eee",
          ...
          <div style={{ display: "flex" }}>
            ...
            <GridTable
              ChangePosition={this.ChangeIndicatorPosition}
              EventKeyBoardChangeValue={this.EventKeyBoardChangeValue}
            />
