            ...
            <div className="ColWord wordCol" style={{ height: this.props.heightCol }}>
                {
                    this.props.ColTable.map((e, col) => {
                        return (
                            // <ResizeProvider  key={col}>
                            //     <ResizeConsumer className={col === this.props.colIndi ? "itemColIndi" : "itemCol"}
                            //         style={{width: col === this.props.colSize ? this.props.width : this.props.widthA / this.props.nColumns  }}
                            //         onClick={() => this.SelectAllCol(col)}
                            //         onSizeChanged={this.ChangeSizeWidth}
                            //     > {e} 
                            //     <div></div>
                            //     </ResizeConsumer>
                            // </ResizeProvider>
